...
let _hexIdCounter = 0;
function useHexId() {
  const ref = reactExports.useRef(`hex-${_hexIdCounter++}`);
  return ref.current;
}
__name(useHexId, "useHexId");
const HexCell2D = /* @__PURE__ */ __name(({
  size = "40px",
  fill = "#d6e9ff",
  label,
  highlight = false
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "div",
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("svg", { viewBox: "142.74 64 114 142.26", style: { width: "100%", height: "100%" }, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("defs", { children: /* @__PURE__ */ jsxRuntimeExports.jsx("filter", { id: glowId, children: /* @__PURE__ */ jsxRuntimeExports.jsx(
          "feDropShadow",
          {
            dx: "0",
            dy: "0",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "polygon",
          {
            ...
            filter: highlight ? `url(#${glowId})` : void 0
          }
        ),
...
const HexCell3D = /* @__PURE__ */ __name(({
  size = "40px",
  fill = "#d6e9ff",
  label,
  highlight = false
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "hex-piece", style: { width: size, height: size }, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "svg",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("defs", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("filter", { id: glowId, children: /* @__PURE__ */ jsxRuntimeExports.jsx(
            "feDropShadow",
            {
              dx: "0",
              dy: "0",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("linearGradient", { id: sideLight, x1: "0", x2: "1", y1: "0", y2: "1", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("stop", { offset: "0", stopColor: "#9ec7ff" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("stop", { offset: "1", stopColor: "#7fb8ff" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("linearGradient", { id: sideDark, x1: "0", x2: "1", y1: "0", y2: "1", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("stop", { offset: "0", stopColor: "#6b9fe6" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("stop", { offset: "1", stopColor: "#4b82c9" })
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "polygon",
...
__name(hexToPixel, "hexToPixel");
function computeBoardCells(cells) {
  const set = /* @__PURE__ */ new Map();
  const key = /* @__PURE__ */ __name((p) => `${p.q},${p.r},${p.s}`, "key");
  if (cells.length === 0) {
...
__name(screenToBoard, "screenToBoard");
function boardToHex(x, y, hexPositions, hexRadius) {
  return findClosestHex(x, y, hexPositions, hexRadius);
}
__name(boardToHex, "boardToHex");
function HiveBoardSVG({
  gameState,
  hoverHex,
  onDropPiece,
  playerColors
  ...
  const [hexRadius, setHexRadius] = reactExports.useState(20);
  const HEX_SIZE = hexRadius * 2;
  const [camera, setCamera] = reactExports.useState({ x: 0, y: 0, scale: 1 });
  const [hoveredHex, setHoveredHex] = reactExports.useState(null);
  const activeHover = hoverHex ?? hoveredHex;
  const [draggingPiece, setDraggingPiece] = reactExports.useState(null);
  const [pointer, setPointer] = reactExports.useState(null);
  reactExports.useEffect(() => {
    if (!boardRef.current) return;
    const updateHexSize = /* @__PURE__ */ __name(() => {
      if (!boardRef.current) return;
  ...
  __name(dropPiece, "dropPiece");
  reactExports.useEffect(() => {
    const handler = /* @__PURE__ */ __name(() => setDraggingPiece(null), "handler");
        ...
        "div",
        {
          ...
          children: [
            hexPositions.map((pos) => {
              ...
              const colour = topPiece ? playerColors[topPiece.owner] : void 0;
              const { x, y } = hexToPixel(pos, hexRadius);
              const half = HEX_SIZE / 2;
              const isHover = activeHover && pos.q === activeHover.q && pos.r === activeHover.r && pos.s === activeHover.s;
              return /* @__PURE__ */ jsxRuntimeExports.jsx(
                "div",
                {
                  style: {
                  ...
                  children: topPiece ? /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "div",
                    {
            ...
            draggingPiece && pointer && /* @__PURE__ */ jsxRuntimeExports.jsx(
              "div",
              {
                style: {
                  position: "absolute",
...
__name(HiveBoardSVG, "HiveBoardSVG");
var cjs = { exports: {} };
var Draggable$1 = {};
...
function GameBoard() {
  ...
  reactExports.useEffect(() => {
    const pageshowHandler = /* @__PURE__ */ __name((event) => {
  ...
  __name(handleHandDrop, "handleHandDrop");
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    gameState.game_over && gameState.winner && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "game-over-popup", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { children: "🎉 Game Over" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: gameState.winner === username ? "You won! 🏆" : `${gameState.winner} won!` })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "hive-root", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: `hive-section opponent ${gameState.player1_turn && opponent === p1 || !gameState.player1_turn && opponent === p2 ? "turn-active" : ""}`, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { children: opponent.username }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          PiecesStrip,
          {
...
function PiecesStrip({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "pieces-block", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "pieces-row", style: { display: "flex", gap: 6 }, children: pieces.map((p) => /* @__PURE__ */ jsxRuntimeExports.jsx(
      DraggableHandPiece,
      {
        piece: p,
        colour,
...
__name(PiecesStrip, "PiecesStrip");
function DraggableHandPiece({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    Draggable,
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { ref: nodeRef, style: { cursor: "grab" }, children: /* @__PURE__ */ jsxRuntimeExports.jsx(
        HexCell3D,
        {
          size: "var(--hex-size)",
          fill: colour,
...
__name(DraggableHandPiece, "DraggableHandPiece");
function App() {
